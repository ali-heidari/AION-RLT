...
## Overview
Aixker-RLT (AION Reinforcement Learning Trainer) is a minimal, modular, and production-ready framework for training and evaluating reinforcement learning (RL) models — designed to be embedded in real systems like load balancers, protocol agents, and distributed services.
...
* **[Aixker Agent](https://github.com/Aixker/aixker-agent)** — AI-native node agent using AION-RLT
...
* AIONX: [https://github.com/AIONX](https://github.com/AIXKER)
